/**
 * 微信小程序JavaScriptSDK
 * 官方http://lbs.qq.com/qqmap_wx_jssdk/index.html
 * @version 1.1
 * @date 2017-06-20
 * @author lngche
 * 比官方增加了路径规划功能，本是自用现开源出来。使用方法同原生文档
 */
var ERROR_CONF = {
    KEY_ERR: 311,
    KEY_ERR_MSG: 'key格式错误',
...
class QQMapWX {
    ...
    /**
     * 用于单起点到多终点的路线规划：
     * 提供步行（walking），默认驾车（driving），公交（transit）
	 *
     * @param {Object} options 接口参数对象
	 *
     * 请求参数结构可以参考
     * http://lbs.qq.com/webservice_v1/guide-road.html
     */
    direction(i) {
        var l = this;
        i = i || {};
